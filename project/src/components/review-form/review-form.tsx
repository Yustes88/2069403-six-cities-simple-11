...
import { postReviewAction } from '../../store/offer/api-actions';
...
function ReviewForm({offerId}: ReviewListPropsType):JSX.Element {
  ...
  const isShort = (userReview.length < ReviewLength.MinLength);
  const isLong = (userReview.length > ReviewLength.MaxLength);
